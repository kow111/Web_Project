...
<head>
<meta charset="utf-8">
<title>Social network feed list - Bootdey.com</title>
        ...
        // <script>
            ...
            $.ajax({
                ...
                success: function(newLikeCount) {
                    ...
                    if (isLiked === true) {
                        $(".btn-xs[data-post-id='" + postId + "']").prepend('<i class="fa fa-thumbs-up"></i>Like this!');
                    } else {
                        $(".btn-xs[data-post-id='" + postId + "']").prepend('<i class="fa fa-thumbs-up"></i>Unlike this!');
                    }
                }
            });
        }
...
<body>
 ...
 -->
	<div class="d-flex flex-column justify-content-center w-100 mx-auto"
		style="max-width: 1000px;font-size: 17px">
		<!-- Post -->
		<div class="panel">
							...
							<div class="modal-content">
								...
								<div class="modal-header align-items-center">
									<h5 class="text-dark text-center w-100 m-0"
										id="exampleModalLabel" style="font-size: 17px">Create Post</h5>
									...
									<div class="my-1 p-1">
										<div class="d-flex flex-column">
											...
											<div class="d-flex align-items-center">
												...
												<div>
													<p class="m-0 fw-bold">${userOwn.name}</p>
												</div>
											</div>
											<!-- text -->
											<div>
								...
								<div class="modal-footer">
									<button type="submit" class="btn btn-primary w-100" style="font-size: 17px">
										Post</button>
								</div>
							</div>
						</div>
